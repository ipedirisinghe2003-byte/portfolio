...
export class Contact {
    ...
    handleSubmit(e) {
        ...
        // Collect form values
        const name = this.contactForm.querySelector('input[placeholder="Your Name"]')?.value || '';
        const fromEmail = this.contactForm.querySelector('input[type="email"]')?.value || '';
        const subject = this.contactForm.querySelector('input[placeholder="Subject"]')?.value || 'Contact Form Message';
